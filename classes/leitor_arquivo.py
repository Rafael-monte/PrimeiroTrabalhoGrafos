...
class LeitorArquivo:
    ...
    def ler_arquivo_entrada(self) -> Grafo:
        with open(INPUT_FILE_LOCATION, 'r') as arquivo_input:
    ...
    def __adicionar_arestas_e_vertices(self) -> None:
        ...
        for linha in self.__arquivo_em_string[1:]:
            ...
            primeiro_valor_vertice, segundo_valor_vertice = linha_formatada[0], linha_formatada[1]
            ...
            self.__grafo.adicionar_aresta(vertice_inicio, vertice_fim, tipo_aresta)
